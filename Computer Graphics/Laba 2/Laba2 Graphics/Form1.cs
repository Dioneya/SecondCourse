...
namespace Laba2_Graphics
{
    public partial class Form1 : Form
    {
        ...
        private void Millimeters_Output(object sender, EventArgs e)
        {
            ...
            {
                y = Math.Pow(x, 5);
                ey = HeightInMM - (Convert.ToInt32(y *

                Convert.ToSingle(200 / g.DpiX * 25.4)) +
                Convert.ToInt32(250 / g.DpiX * 25.4));
                if (ex != 0) { g.DrawLine(graphicsPen, old_ex, old_ey, ex, ey); }
                old_ex = ex; old_ey = ey;
        ...
        private void Inches_Output(object sender, EventArgs e)
        {
            ...
            {
                y = Convert.ToSingle(Math.Pow(x,5))/20000000000000;
        ...
        {
            Millimeters_Output(sender, e);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            Inches_Output(sender, e);
        }

        private void button4_Click(object sender, EventArgs e)
        {
            Clear_PictureBox(sender, e);
        }
    }
}
